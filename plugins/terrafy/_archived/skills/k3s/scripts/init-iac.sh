...
# Use k3s skill or run script directly

# With custom directory
bash \$CLAUDE_PLUGIN_ROOT/skills/k3s/scripts/snapshot-k3s.sh -d ${IAC_ROOT}
...
---
*Generated by terrafy plugin on $(date)*
*IaC Root: ${IAC_ROOT}*
EOF
...
print_summary() {
    ...
    echo "  2. Create K3s snapshot: Use k3s skill or run snapshot-k3s.sh"
